...
from src.model.model1 import PurchasePred
...
if __name__ == "__main__":
    ...
    train_dataloader, valid_dataloader = _model.prepare_dataloader(dates[2])
    ...
    # train_dataloader, valid_dataloader = _model.datamanager.prepare_dataloader(
